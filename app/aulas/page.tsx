...
type Participant={id:string;student_id:string;name:string;email:string;phone:string;avatar_url?:string|null;belt:string;degrees:number;present:boolean;checked_in_at?:string|null};
