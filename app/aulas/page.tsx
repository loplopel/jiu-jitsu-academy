...
type Participant={id:string;student_id:string;name:string;login?:string;contact_email?:string;phone:string;avatar_url?:string|null;belt:string;degrees:number;present:boolean;checked_in_at?:string|null};
...
export default function Page(){
  ...
  return <AppShell>
    <section className="hero"><div className="split"><div><h1>Aulas e reservas</h1><div className="muted">Professor abre a aula, aluno reserva e a presença é confirmada somente pelo QR Code.</div></div>{staff&&<button className="btn btn-primary" onClick={()=>{resetForm();setOpen(v=>!v)}}><Plus size={16}/> Nova aula</button>}</div></section>
